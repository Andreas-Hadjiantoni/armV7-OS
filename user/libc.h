...
//open a file if it exists, or create it if it does not
extern void open (const char* fname, uint32_t mode );
//return PID of the executing process
extern int getMyPid();
#endif
